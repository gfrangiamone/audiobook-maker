...
| VC-06d | Brano e scelte dopo una bozza ripresa | Con una bozza a campione accettato, ricarica la pagina, riprendi la procedura (si apre il pagamento) e premi «Indietro»; ripeti con «Rifai il campione» | Il riquadro del brano è pieno, nel testo della lingua scelta all'inizio; registrando o caricando un file il campione viene verificato normalmente e non compare mai «Dati mancanti o non validi» | |
