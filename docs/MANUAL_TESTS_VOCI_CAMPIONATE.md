...
| VC-07d | I due brani di prova sono spiegati | Guarda il riquadro dei brani di prova nel pannello del pagamento | È scritto che dopo il pagamento parte l'elaborazione del campione e la generazione di due brevi brani letti con la propria voce; il primo è mostrato per esteso come frase fissa uguale per tutte le voci, del secondo è scritto che lo sorteggia la piattaforma e non c'è nessuna combo da scegliere | |
