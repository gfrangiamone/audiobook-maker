...
2. **Roman numerals** → Write them out in full in the text's language (e.g. "Henry VIII" → "Henry the Eighth", "Leone XIV" → "Leone Quattordicesimo", "Capitolo III" → "Capitolo Terzo"). Pay attention "XI" jinping is a person, not a number.
