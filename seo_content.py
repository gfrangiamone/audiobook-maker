    ...
    "it": {
        ...
        "faqs": [
            ...
            ("Quali strumenti posso usare per ascoltare un audiolibro generato da Audiobook Maker?",
             "Lo strumento ottimale è l'app ufficiale Audiobook Maker & Player, disponibile per Android "
             "e iOS. Con l'app puoi avviare la generazione dei tuoi audiolibri (solo voci gratuite), seguire "
             "l'avanzamento del lavoro e ottenere direttamente nella tua libreria in-app gli audiolibri "
             "pronti all'ascolto. Il cuore dell'app è un player semplicissimo da usare ma completo di tutte "
             "le funzioni utili: gestione dei capitoli, segnalibri, lettura rallentata o velocizzata, sleep "
             "mode e molto altro. Se invece preferisci avviare la generazione dal sito web (voci gratuite o "
             "PREMIUM), puoi trasferire in qualunque momento il tuo job sull'app e nella sua libreria tramite lettura del QR Code. "
             "Infine, con l'app puoi condividere i tuoi audiolibri con i tuoi amici in modo semplice e veloce. "
             "Scaricala subito: versione Android (https://play.google.com/store/apps/details?id=it.abm.audiobook_maker_mobile) e versione iOS (https://apps.apple.com/it/app/audiobook-maker-player/id6793015763). "
             "In alternativa, i file MP3 e M4B generati possono essere ascoltati con qualsiasi lettore audio, "
             "oppure puoi usare il feed podcast RSS per ascoltare i capitoli nella tua app podcast preferita."),
    ...
    "en": {
        ...
        "faqs": [
            ...
            ("What tools can I use to listen to an audiobook generated by Audiobook Maker?",
             "The best tool is the official Audiobook Maker & Player app, available for Android and iOS. "
             "With the app you can start generating your audiobooks (free voices only), follow the progress "
             "of the job and get the finished audiobooks straight into your in-app library, ready to listen. "
             "At its heart is a player that is extremely simple to use yet packed with every useful feature: "
             "chapter management, bookmarks, slower or faster playback, sleep mode and much more. If you "
             "prefer to start a generation from the website instead (free or PREMIUM voices), you can "
             "transfer your job to the app and its library at any time by scanning a QR code. "
             "Finally, the app lets you share your audiobooks with your friends quickly and easily. "
             "Download it now: Android version (https://play.google.com/store/apps/details?id=it.abm.audiobook_maker_mobile) and iOS version (https://apps.apple.com/it/app/audiobook-maker-player/id6793015763). "
             "Alternatively, the MP3 and M4B files generated by Audiobook Maker can be played with any audio "
             "player, or you can use the podcast RSS feed to listen to the chapters in your favourite podcast app."),
    ...
    "fr": {
        ...
        "faqs": [
            ...
            ("Quels outils utiliser pour écouter un livre audio généré par Audiobook Maker ?",
             "L'outil idéal est l'application officielle Audiobook Maker & Player, disponible pour Android "
             "et iOS. Avec l'application, vous pouvez lancer la génération de vos livres audio (voix "
             "gratuites uniquement), suivre l'avancement du travail et retrouver directement dans votre "
             "bibliothèque intégrée les livres audio prêts à écouter. Son cœur est un lecteur très simple à "
             "utiliser mais complet : gestion des chapitres, signets, lecture ralentie ou accélérée, mode "
             "veille et bien plus encore. Si vous préférez lancer la génération depuis le site web (voix "
             "gratuites ou PREMIUM), vous pouvez à tout moment transférer votre travail vers l'application "
             "et sa bibliothèque en scannant un QR Code. "
             "Enfin, l'application permet de partager vos livres audio avec vos amis simplement et rapidement. "
             "Téléchargez-la : version Android (https://play.google.com/store/apps/details?id=it.abm.audiobook_maker_mobile) et version iOS (https://apps.apple.com/it/app/audiobook-maker-player/id6793015763). "
             "Sinon, les fichiers MP3 et M4B générés peuvent être lus avec n'importe quel lecteur audio, ou "
             "vous pouvez utiliser le flux RSS podcast pour écouter les chapitres dans votre application podcast préférée."),
    ...
    "es": {
        ...
        "faqs": [
            ...
            ("¿Qué herramientas puedo usar para escuchar un audiolibro generado por Audiobook Maker?",
             "La herramienta óptima es la app oficial Audiobook Maker & Player, disponible para Android e "
             "iOS. Con la app puedes iniciar la generación de tus audiolibros (solo voces gratuitas), seguir "
             "el avance del trabajo y obtener directamente en tu biblioteca integrada los audiolibros listos "
             "para escuchar. Su núcleo es un reproductor sencillísimo de usar pero completo con todas las "
             "funciones útiles: gestión de capítulos, marcadores, lectura ralentizada o acelerada, modo de "
             "apagado automático y mucho más. Si prefieres iniciar la generación desde la web (voces "
             "gratuitas o PREMIUM), puedes transferir en cualquier momento tu trabajo a la app y a su "
             "biblioteca escaneando un código QR. "
             "Por último, con la app puedes compartir tus audiolibros con tus amigos de forma sencilla y rápida. "
             "Descárgala ahora: versión Android (https://play.google.com/store/apps/details?id=it.abm.audiobook_maker_mobile) y versión iOS (https://apps.apple.com/it/app/audiobook-maker-player/id6793015763). "
             "Como alternativa, los archivos MP3 y M4B generados se pueden reproducir con cualquier "
             "reproductor de audio, o puedes usar el feed RSS podcast para escuchar los capítulos en tu app de podcast favorita."),
    ...
    "de": {
        ...
        "faqs": [
            ...
            ("Welche Tools kann ich verwenden, um ein von Audiobook Maker erstelltes Hörbuch zu hören?",
             "Das optimale Werkzeug ist die offizielle App Audiobook Maker & Player für Android und iOS. "
             "Mit der App können Sie die Erstellung Ihrer Hörbücher starten (nur kostenlose Stimmen), den "
             "Fortschritt verfolgen und die fertigen Hörbücher direkt in Ihrer In-App-Bibliothek zum "
             "Anhören erhalten. Herzstück ist ein sehr einfach zu bedienender, aber vollständig "
             "ausgestatteter Player: Kapitelverwaltung, Lesezeichen, langsamere oder schnellere Wiedergabe, "
             "Sleep-Timer und vieles mehr. Wenn Sie die Erstellung lieber auf der Website starten (kostenlose "
             "oder PREMIUM-Stimmen), können Sie den Auftrag jederzeit per QR-Code-Scan in die App und deren "
             "Bibliothek übertragen. "
             "Schließlich können Sie Ihre Hörbücher mit der App schnell und einfach mit Freunden teilen. "
             "Jetzt herunterladen: Android-Version (https://play.google.com/store/apps/details?id=it.abm.audiobook_maker_mobile) und iOS-Version (https://apps.apple.com/it/app/audiobook-maker-player/id6793015763). "
             "Alternativ können die erzeugten MP3- und M4B-Dateien mit jedem Audioplayer abgespielt werden, "
             "oder Sie nutzen den Podcast-RSS-Feed, um die Kapitel in Ihrer Lieblings-Podcast-App zu hören."),
    ...
    "zh": {
        ...
        "faqs": [
            ...
            ("可以用什么工具收听Audiobook Maker生成的有声书？",
             "最佳工具是官方应用 Audiobook Maker & Player，支持 Android 和 iOS。"
             "使用该应用，您可以直接发起有声书的生成（仅限免费语音）、跟踪任务进度，"
             "并在应用内书库中获得可立即收听的有声书。"
             "应用的核心是一个极其易用且功能完备的播放器：章节管理、书签、减速或加速播放、睡眠定时等。"
             "如果您更喜欢在网站上发起生成（免费或 PREMIUM 语音），"
             "也可以随时通过扫描二维码将任务转移到应用及其书库中收听。"
             "此外，您还可以用该应用快速便捷地与朋友分享有声书。"
             "立即下载：Android 版本 (https://play.google.com/store/apps/details?id=it.abm.audiobook_maker_mobile) 和 iOS 版本 (https://apps.apple.com/it/app/audiobook-maker-player/id6793015763)。"
             "此外，生成的 MP3 和 M4B 文件也可以用任何音频播放器播放，"
             "或使用播客 RSS 订阅源在您喜爱的播客应用中收听章节。"),
            ("什么是AI文本优化？它有哪些优势？",
    ...
    "hi": {
        ...
        "faqs": [
            ...
            ("Audiobook Maker द्वारा जनरेट की गई ऑडियोबुक्स को मैं कैसे सुन सकता हूँ?",
             "सबसे बेहतर विकल्प आधिकारिक ऐप Audiobook Maker & Player है, जो Android और iOS दोनों के लिए उपलब्ध है. "
             "ऐप से आप अपनी ऑडियोबुक्स का जनरेशन शुरू कर सकते हैं (केवल मुफ़्त आवाज़ें), काम की प्रगति देख सकते हैं "
             "और तैयार ऑडियोबुक्स सीधे ऐप की लाइब्रेरी में सुनने के लिए पा सकते हैं. "
             "ऐप का केंद्र एक बेहद आसान लेकिन पूर्ण प्लेयर है: अध्याय प्रबंधन, बुकमार्क, धीमी या तेज़ गति से सुनना, स्लीप मोड और बहुत कुछ. "
             "अगर आप वेबसाइट से जनरेशन शुरू करना पसंद करते हैं (मुफ़्त या PREMIUM आवाज़ें), तो QR कोड स्कैन करके "
             "अपना जॉब कभी भी ऐप और उसकी लाइब्रेरी में ट्रांसफ़र कर सकते हैं. "
             "अंत में, ऐप से आप अपनी ऑडियोबुक्स दोस्तों के साथ आसानी से और तेज़ी से साझा कर सकते हैं. "
             "अभी डाउनलोड करें: Android संस्करण (https://play.google.com/store/apps/details?id=it.abm.audiobook_maker_mobile) और iOS संस्करण (https://apps.apple.com/it/app/audiobook-maker-player/id6793015763). "
             "विकल्प के रूप में, जनरेट की गई MP3 और M4B फ़ाइलें किसी भी ऑडियो प्लेयर से चलाई जा सकती हैं, "
             "या आप पॉडकास्ट RSS फ़ीड का उपयोग करके अपने पसंदीदा पॉडकास्ट ऐप में अध्याय सुन सकते हैं."),
