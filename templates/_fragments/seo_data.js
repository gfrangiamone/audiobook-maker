...
const SEO={
it:{
title:"Audiobook Maker — EPUB/PDF in Audiolibro Gratis | MP3 e M4B con Capitoli",
...
kw:"convertitore epub m4b, creare m4b con capitoli, convertitore epub audiolibro, epub in audiolibro gratis, pdf in audiolibro, convertire pdf in audiolibro online, epub to m4b, pdf to m4b, text to speech italiano, da libro a audiolibro gratis, convertitore audiolibro online gratuito, trasformare ebook in audio, sintesi vocale libro, audiolibro maker, convertire libro in audio gratis, ebook to audiobook italiano, tts italiano gratis, creare audiolibro gratis online, convertitore testo in voce, epub reader audio, da testo ad audiolibro, ascoltare ebook, libro parlato gratis, alternativa a speechify, alternativa a naturalreader, tts online gratis, narratore ai, text to speech mp3 download, app lettura ad alta voce, ascoltare libri, convertitore audiolibro open source, generatore podcast rss per audiolibri",
ld:"Audiobook Maker",
features:["Conversione EPUB in audiolibro MP3/M4B (con capitoli)","Conversione PDF in audiolibro MP3/M4B (con capitoli)","400+ voci neurali AI (Microsoft Edge TTS)","50+ lingue supportate","Selezione capitoli e anteprima","Generazione feed Podcast RSS","Notifica email per conversioni lunghe","Nessuna registrazione richiesta","Nessun limite di utilizzo","Funziona nel browser"]
},
en:{
...
kw:"epub to m4b converter, create m4b with chapters, pdf to m4b, epub to audiobook converter, pdf to audiobook converter, free epub to audiobook, free pdf to audiobook, convert ebook to audiobook online free, epub to mp3 converter, pdf to mp3 converter, text to speech audiobook, free audiobook maker online, ebook to audiobook converter, epub to audio, online audiobook creator free, turn ebook into audiobook, tts audiobook generator, convert epub to mp3 free, free text to speech book reader, ai audiobook maker, epub audiobook converter online, ebook to mp3, listen to epub, epub reader with audio, book to audiobook converter free, create audiobook from epub, create audiobook from pdf, speechify alternative, naturalreader alternative, tts online free, ai narrator, text to speech mp3 download, read aloud app, listen to books, open source audiobook converter, podcast rss generator for audiobooks",
ld:"Audiobook Maker",
features:["EPUB to MP3/M4B audiobook conversion (with chapters)","PDF to MP3/M4B audiobook conversion (with chapters)","400+ neural AI voices (Microsoft Edge TTS)","50+ languages supported","Chapter selection and preview","Podcast RSS feed generation","Email notification for long conversions","No registration required","No usage limits","Browser-based processing"]
},
fr:{
title:"Audiobook Maker — EPUB/PDF en Livre Audio Gratuit | MP3 et M4B",
desc:"Convertissez vos ebooks EPUB et PDF en livres audio MP3 et M4B (avec chapitres) gratuitement avec des voix IA naturelles. Convertisseur en ligne gratuit text-to-speech : téléchargez votre livre, choisissez une voce et téléchargez votre livre audio professionnel. Aucune installation, fonctionne dans le navigateur.",
kw:"convertisseur epub m4b, créer m4b avec chapitres, convertisseur epub livre audio, convertisseur pdf livre audio, epub en livre audio gratuit, pdf en livre audio gratuit, convertir ebook en livre audio en ligne, créer livre audio gratuit, text to speech français, convertisseur livre audio en ligne gratuit, epub vers m4b, pdf vers m4b, transformer ebook en audio, synthèse vocale livre, audiobook maker, convertir livre en audio gratuit, ebook to audiobook français, tts français gratuit, créer livre audio en ligne, convertisseur texte en voix, epub lecteur audio, de texte à livre audio, écouter ebook, livre parlé gratuit, epub en audio gratuit, pdf en audio gratuit, alternative à speechify, alternative à naturalreader, tts en ligne gratuit, narrateur ia, text to speech mp3 télécharger, application lecture à voix haute, écouter des livres, convertisseur livre audio open source, générateur rss podcast pour livres audio",
ld:"Audiobook Maker",
features:["Conversion EPUB en livre audio MP3/M4B (avec chapitres)","Conversion PDF en livre audio MP3/M4B (avec chapitres)","400+ voix IA neuronales (Microsoft Edge TTS)","50+ langues supportées","Sélection de chapitres et aperçu","Génération de flux Podcast RSS","Notification par e-mail pour les conversions longues","Aucune inscription requise","Aucune limite d'utilisation","Fonctionne dans le navigateur"]
},
es:{
...
kw:"epub zu m4b konverter, m4b mit kapiteln erstellen, epub zu hörbuch konverter, pdf zu hörbuch konverter, epub in hörbuch umwandeln kostenlos, pdf in hörbuch umwandeln kostenlos, ebook in hörbuch umwandeln online, hörbuch erstellen kostenlos, text to speech deutsch, hörbuch konverter online kostenlos, epub zu m4b, pdf zu m4b, ebook in audio umwandeln, sprachsynthese buch, audiobook maker, buch in hörbuch umwandeln kostenlos, ebook to audiobook deutsch, tts deutsch kostenlos, hörbuch erstellen online gratis, text in sprache konverter, epub vorlesen lassen, text zu hörbuch, ebook anhören, hörbuch maker kostenlos, epub zu audio kostenlos, pdf zu audio kostenlos, speechify alternative, naturalreader alternative, tts online kostenlos, ki-erzähler, text to speech mp3 herunterladen, vorlese-app, bücher anhören, open source hörbuch konverter, podcast rss generator für hörbücher",
ld:"Audiobook Maker",
features:["EPUB-zu-MP3/M4B-Hörbuch-Konvertierung (mit Kapiteln)","PDF-zu-MP3/M4B-Hörbuch-Konvertierung (mit Kapiteln)","400+ neuronale KI-Stimmen (Microsoft Edge TTS)","50+ unterstützte Sprachen","Kapitelauswahl und Vorschau","Podcast RSS-Feed Generierung","E-Mail-Benachrichtigung bei langen Konvertierungen","Keine Registrierung erforderlich","Keine Nutzungsbeschränkungen","Browser-basierte Verarbeitung"]
},
zh:{
